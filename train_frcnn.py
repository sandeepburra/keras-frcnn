...
################################################################################################################################
	...
	write_log(callback2, names_1, loss_rpn_val, epoch_num)
	write_log(callback3, names_2, loss_class, epoch_num)
	write_log(callback4, names_2, loss_class_val, epoch_num)
